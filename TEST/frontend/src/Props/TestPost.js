...
function TestPost(props) {
    ...
    const handleSell = (e) => {
        ...
        var data = new FormData()
        data.append("_id",props.postData._id)
        data.append("old_owner",props.postData.postOwner)
	...
	return (
      ...
      {showForm2 && (
        ...
        <form onSubmit={handleSell}>
                        <input type="text" name="new_owner" className="form-control form-control-sm" placeholder="Enter New Owner" defaultValue={postData.new_owner} required />
                        <input type="text" name="price" className="form-control form-control-sm" placeholder="Enter Price" defaultValue={postData.price} required/>
                        <div className="text-center">
